...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Интервал-пересечения двух диапазонов:" + range1.getIntersectionRange(range2));
        System.out.println("Объединение двух диапазонов:" + deepToString(range1.getUnion(range2)));
        System.out.println("Разность двух диапазонов:" + deepToString(range1.getDifference(range2)));
    }
}