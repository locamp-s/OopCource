...
public class Triangle implements Shape {
    ...
    private double getSideLength(double x1, double x2, double y2, double y1) {
        return Math.sqrt(Math.pow(x2 - x1, 2) + Math.pow(y2 - y1, 2));
    }

    @Override
    public double getPerimeter() {
        return getSideLength(x1, x2, y2, y1) + getSideLength(x2, x3, y2, y3) + getSideLength(x3, x1, y3, y1);
    }
